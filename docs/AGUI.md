...
an alternative AG-UI-compatible client alongside the production Next.js frontend.
...
service, the same role the Next.js BFF plays for the vanilla API. Direct browser access to the
