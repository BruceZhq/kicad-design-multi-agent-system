...
class EvolutionServiceTest {
    ...
    void managementApiCannotManufactureEvaluationProof(EvolutionCandidate.Status target) {
        ...
        EvolutionService service = service(tenantAccess, repository);
    ...
    private EvolutionService service(TenantAccess tenantAccess, EvolutionRepository repository) {
        return new EvolutionService(
                tenantAccess,
                mock(TenantContext.class),
                repository,
                mock(HarnessVersionService.class),
