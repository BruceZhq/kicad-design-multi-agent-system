...
class EvolutionRepository {
    ...
    EvolutionRepository(JdbcClient jdbcClient, ObjectMapper objectMapper) {
    ...
    boolean insertObservation(UUID tenantId, EvolutionObservation value) {
    ...
    List<EvolutionObservation> findActiveGaps(
        ...
        return jdbcClient.sql("select " + OBSERVATION_COLUMNS + """
                        ...
                        where o.tenant_id = :tenantId
                          ...
                          and o.event_type = 'capability_gap'
                          and not exists (
                              select 1
