...
@Repository
public class JdbcRunOutbox implements RunOutbox {

    private final JdbcClient jdbcClient;
    private final ObjectMapper objectMapper;

    public JdbcRunOutbox(JdbcClient jdbcClient, ObjectMapper objectMapper) {
        this.jdbcClient = jdbcClient;
        this.objectMapper = objectMapper;
    }

    @Transactional(propagation = Propagation.MANDATORY)
    public boolean append(UUID tenantId, UUID runId, String eventType, Map<String, Object> payload) {
        return append(tenantId, runId, null, eventType, payload);
    }

    @Transactional(propagation = Propagation.MANDATORY)
    public boolean appendSourceEvent(
            UUID tenantId,
            UUID runId,
            long sourceEventSeq,
            String eventType,
    ...
    public List<OutboxEvent> claim(String workerId, int batchSize) {
    ...
    public boolean acknowledge(UUID eventId, String workerId) {
    ...
    public boolean retry(UUID eventId, String workerId, int delaySeconds) {
        return Boolean.TRUE.equals(jdbcClient
