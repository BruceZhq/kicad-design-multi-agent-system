...
@Repository
public class JdbcRunInteractionStore implements RunInteractionStore {

    private final JdbcClient jdbcClient;
    private final ObjectMapper objectMapper;

    public JdbcRunInteractionStore(JdbcClient jdbcClient, ObjectMapper objectMapper) {
    ...
    public Optional<RunInteraction> findForUpdate(UUID tenantId, UUID runId, String interactionId) {
    ...
    public void markResponded(RunInteraction interaction) {
        jdbcClient.sql("""
                        update control_plane.run_interactions
