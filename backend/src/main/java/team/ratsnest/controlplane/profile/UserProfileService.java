...
class UserProfileService {
    ...
    private final ProfileAvatarStorage avatars;
    private final TransactionTemplate transactions;

    UserProfileService(
            TenantContext tenantContext,
            UserProfileRepository profiles,
            ProfileAvatarStorage avatars,
    ...
    ProfileView get(ProfileIdentity identity) {
    ...
    ProfileAvatarStorage.AvatarContent avatar(ProfileIdentity identity) {
