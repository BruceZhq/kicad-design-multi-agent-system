package team.ratsnest.controlplane.project.api;
...
public class ProjectController {
    ...
    List<ProjectResponse> list(
        ...
        return projects.list(tenantId, JwtIdentity.from(jwt)).stream()
    ...
    ProjectResponse get(
        ...
        return ProjectResponse.from(
                projects.get(tenantId, projectId, JwtIdentity.from(jwt)));
    }
