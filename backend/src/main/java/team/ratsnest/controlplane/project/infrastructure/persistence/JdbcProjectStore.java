package team.ratsnest.controlplane.project.infrastructure.persistence;
...
public class JdbcProjectStore implements ProjectStore {
    ...
    public JdbcProjectStore(JdbcClient jdbcClient) {
    ...
    public List<Project> findAll(UUID tenantId) {
    ...
    public int update(UUID tenantId, UUID projectId, String name, String description) {
        return jdbcClient.sql("""
