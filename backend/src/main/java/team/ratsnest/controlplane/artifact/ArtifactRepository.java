...
public class ArtifactRepository {
    ...
    public ArtifactRepository(JdbcClient jdbcClient) {
        this.jdbcClient = jdbcClient;
    }

    public boolean persist(Run run, ArtifactManifest manifest) {
        int inserted = jdbcClient.sql("""
                ...
                .update();
        if (inserted == 0) {
            requireSameManifest(run, manifest);
            return false;
        }
    ...
    private void requireSameManifest(Run run, ArtifactManifest manifest) {
